...
{
    public class ImportViewModel : ViewModelBase<MixCmsContext, MixLocalize, ImportViewModel>
    {
        #region Properties
        ...
        public ImportViewModel(MixLocalize model, MixCmsContext _context = null, IDbContextTransaction _transaction = null)
